...
<head>
    ...
    <title>Pharmasiya.com - Ready Orders</title>
...
<body>
    ...
    <div class="row" >
        ...
        <div class="col-md-6 text-center justify-content-center">
            <table class="table table-hover table-responsive">
              ...
              // session_start();
               $shop= $_SESSION['name'];
               $query_AccountDetails= "select * from orders where statuss='Ready' and pharma='$shop'  ";
    ...
    echo'  <tr>
      ...
      <td> <button type="button" class="btn btn-danger" id='.$row_AccountDetails['id'].'  onclick="getid(this.id)">Mark As Dilivered</button></td>
    ...
    <div class="modal fade" id="detailsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true" onload="getid();">
        ...
        <div class="modal-content">
            ...
            <button type="button" class="btn btn-warning" onclick=" getidsss1();">Dilivered</button>
...
function getids(loid){
 ...
 // alert(idn);
  ...
  function getidsss1(){
    ...
    if (window.confirm('Do You need to mark as dilivered this order?'))
{
 ...
 // document.getElementById('clik').value=loid;
  ...
  function remov(){
    if (window.confirm('Do You need to Delete this order?'))
{
