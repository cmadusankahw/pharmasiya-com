...
<head>
    ...
    <title>Pharmasiya.com- All Orders</title>
   ...
   <?php include('nav.php'); ?>
    ...
    <div class="modal fade" id="detailsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true" onload="getid();">
        ...
        <div class="modal-content">
                ...
                <table class="table table-responsive text-center" style="margin:auto; width:80%;">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <div class="col">
                        <input type="text" id="price" placeholder="Enter Price of medicine">
            ...
            <button type="button" class="btn btn-warning" onclick=" newready();">Ready</button>
            <button type="button" class="btn btn-danger" onclick=" remov();">Reject</button>
...
function getids(loid){
 ...
 // var accNo=$('#clik').val();
  ...
  function newready(){
    ...
    if (window.confirm('Do You need Mark as ready? '))
{
